...
namespace Alliance.Server.Extensions.FlagsTracker.Behaviors
{
    ...
    public class FlagTracker
    {
        ...
        public FlagTracker(Agent agent, MissionWeapon flag)
        {
            ...
            GameEntity entity = GameEntity.Instantiate(Mission.Current.Scene, "CS_Capturable_Zone", agent.Frame);
            ...
            GameNetwork.WriteMessage(new CreateMissionObject(flagZone.Id, "CS_Capturable_Zone", agent.Frame, list));
            ...
            Mission.Current.AddDynamicallySpawnedMissionObjectInfo(new Mission.DynamicallyCreatedEntity("CS_Capturable_Zone", flagZone.Id, agent.Frame, ref list));
