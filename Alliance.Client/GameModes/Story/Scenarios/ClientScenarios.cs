        ...
        public static Scenario BFHD()
        {
            return CommonScenarios.BFHD(
                    onActShowResults: winnerSide =>
                    {
                        ...
                        sv.ShowResultScreen(
                                GameTexts.FindText($"str_pvc_act_{suffix}", "BFHD_1").ToString(),
                                GameTexts.FindText($"str_pvc_act_{suffix}", "BFHD_1").ToString(),
                                color);
                    },
                    onActCompleted: null,
                    onActShowResults2: winnerSide =>
                    {
                        ...
                        Color color = winnerSide == playerSide ? new Color(0.4f, 0.7f, 0.1f) : new Color(0.7f, 0.1f, 0.1f);
                        sv.ShowResultScreen(
                                GameTexts.FindText($"str_pvc_act_{suffix}", "BFHD_2").ToString(),
                                GameTexts.FindText($"str_pvc_act_{suffix}", "BFHD_2").ToString(),
                                color);
                    },
        ...
        public static Scenario GP()
        {
            return CommonScenarios.GP(
                onActShowResults: winnerSide =>
                {
                    ...
                    Color color = winnerSide == playerSide ? new Color(0.4f, 0.7f, 0.1f) : new Color(0.7f, 0.1f, 0.1f);
                    sv.ShowResultScreen(
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_1").ToString(),
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_1").ToString(),
                            color);
                },
                onActCompleted: null,
                onActShowResults2: winnerSide =>
                {
                    ...
                    Color color = winnerSide == playerSide ? new Color(0.4f, 0.7f, 0.1f) : new Color(0.7f, 0.1f, 0.1f);
                    sv.ShowResultScreen(
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_2").ToString(),
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_2").ToString(),
                            color);
                },
                onActCompleted2: null,
                onActShowResults3: winnerSide =>
                {
                    ...
                    Color color = winnerSide == playerSide ? new Color(0.4f, 0.7f, 0.1f) : new Color(0.7f, 0.1f, 0.1f);
                    sv.ShowResultScreen(
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_3").ToString(),
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_3").ToString(),
                            color);
                },
                ...
                onActShowResults4: winnerSide =>
                {
                    ...
                    Color color = winnerSide == playerSide ? new Color(0.4f, 0.7f, 0.1f) : new Color(0.7f, 0.1f, 0.1f);
                    sv.ShowResultScreen(
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_4").ToString(),
                            GameTexts.FindText($"str_pvc_act_{suffix}", "GP_4").ToString(),
                            color);
                },
