...
{
	[PhrasePreview("{Name}{?Type!=Agent,GameEntity: : {DefaultValue}}")]
	[PhraseTemplate(
		"Variable {Name} is a",
		"{?Type=Agent,GameEntity:{Type}}{?Type!=Agent,GameEntity:{Type}{?Type=Enum:→{EnumTypeName}} with default value = {DefaultValue}}")]
	public class ScenarioVariable
	{
		...
		[ConfigProperty(label: "Default Value", tooltip: "Default value.",
			dependency: $"?{nameof(Type)}!=Agent&?{nameof(Type)}!=GameEntity")]
