    ...
    public class CommonScenarios
    {
            ...
            OnActVictoryDelegate onActShowResults2, OnActVictoryDelegate onActCompleted2)
        {
            ...
            Scenario bfhd = new Scenario(
                id: scenarioId,
                name: GameTexts.FindText("str_pvc_scenario_name", scenarioId).ToString(),
                desc: GameTexts.FindText("str_pvc_scenario_description", scenarioId).ToString()
                );
            ...
            Act act1 = new Act(
                name: GameTexts.FindText("str_pvc_act_name", scenarioId + actId).ToString(),
                desc: GameTexts.FindText("str_pvc_act_description", scenarioId + actId).ToString(),
                loadMap: true,
            ...
            TimerObjective act1objective1 = new TimerObjective(
                ...
                GameTexts.FindText("str_pvc_obj_name", scenarioId + actId + "_1").ToString(),
                GameTexts.FindText("str_pvc_obj_description", scenarioId + actId + "_1").ToString(),
                true, false, 3600);
            KillCountObjective act1objective2 = new KillCountObjective(
                BattleSideEnum.Defender,
                GameTexts.FindText("str_pvc_obj_name", scenarioId + actId + "_2").ToString(),
                GameTexts.FindText("str_pvc_obj_description", scenarioId + actId + "_2").ToString(),
                true, false, 10000);
            KillAllObjective act1objective3 = new KillAllObjective(
                BattleSideEnum.Attacker,
                GameTexts.FindText("str_pvc_obj_name", scenarioId + actId + "_3").ToString(),
                GameTexts.FindText("str_pvc_obj_description", scenarioId + actId + "_3").ToString(),
                true, true);
