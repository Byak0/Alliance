...
namespace Alliance.Common.GameModes.Story.Actions
{
	...
	public class ShowOrHideEntitiesAction : ActionBase
	{
		...
		public string Tag;
		[ConfigProperty(label: "Visible", tooltip: "Show or hide the entities.")]
		public bool Visible;
		[ConfigProperty(label: "Toggle", tooltip: "If enabled, the action will toggle the visibility of the entities instead of setting it to the specified value.")]
		public bool Toggle;
