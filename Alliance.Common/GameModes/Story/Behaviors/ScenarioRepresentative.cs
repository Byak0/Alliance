...
{
    public class ScenarioRepresentative : MissionRepresentativeBase
    {
        public static ScenarioRepresentative Main => GameNetwork.MyPeer?.GetComponent<ScenarioRepresentative>();
