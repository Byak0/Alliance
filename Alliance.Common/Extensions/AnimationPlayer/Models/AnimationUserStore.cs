...
namespace Alliance.Common.Extensions.AnimationPlayer.Models
{
    ...
    public class AnimationUserStore
    {
        ...
        public void Init()
        {
            ...
            {
                _filePath = Path.Combine(ModuleHelper.GetModuleFullPath("Alliance"), "Animations/AvailableAnimations.xml");
            ...
            else
            {
                ...
                {
                    string path = Path.Combine(ModuleHelper.GetModuleFullPath("Alliance"), "Animations/AvailableAnimations.xml");
                    if (File.Exists(path))
                    {
                        Deserialize(path);
                    }
