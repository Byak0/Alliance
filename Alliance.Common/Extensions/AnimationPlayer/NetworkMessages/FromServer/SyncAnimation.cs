...
namespace Alliance.Common.Extensions.AnimationPlayer.NetworkMessages.FromServer
{
	...
	public sealed class SyncAnimation : GameNetworkMessage
	{
		...
		protected override bool OnRead()
		{
			...
			Index = ReadIntFromPacket(CompressionHelper.AnimationCompressionInfo, ref bufferReadValid);
		...
		protected override void OnWrite()
		{
			...
			WriteIntToPacket(Index, CompressionHelper.AnimationCompressionInfo);
