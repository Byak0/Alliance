...
namespace Alliance.Common.Extensions.AnimationPlayer.NetworkMessages.FromClient
{
	...
	public sealed class RequestAnimation : GameNetworkMessage
	{
		...
		protected override bool OnRead()
		{
			...
			ActionIndex = ReadIntFromPacket(CompressionHelper.AnimationCompressionInfo, ref bufferReadValid);
		...
		protected override void OnWrite()
		{
			...
			WriteIntToPacket(ActionIndex, CompressionHelper.AnimationCompressionInfo);
