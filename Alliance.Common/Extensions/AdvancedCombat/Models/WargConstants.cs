...
namespace Alliance.Common.Extensions.AdvancedCombat.Models
{
	public static class WargConstants
	{
		...
		public static readonly ActionIndexCache DefendAnimation;
		...
		public const float ATTACK_COOLDOWN = 5; // Cooldown between attacks

		static WargConstants()
		{
			ActionIndexCache rear = ActionIndexCache.Create("act_warg_rear");
			...
			IdleAnimations = new List<ActionIndexCache>() { rear, idle1, idle1, idle2, idle2 };
			CarefulAnimations = new List<ActionIndexCache>() { rear, idle1, idle1, idle1, idle1, idle1 };
			...
			DefendAnimation = ActionIndexCache.Create("act_quick_release_thrust_2h");
		}
	}
}
