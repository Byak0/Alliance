...
namespace Alliance.Common.Extensions.Vehicles.NetworkMessages.FromClient
{
    ...
    public sealed class CS_VehicleRequestBackward : GameNetworkMessage
    {
        public MissionObjectId MissionObjectId { get; private set; }
        public bool Move { get; private set; }

        public CS_VehicleRequestBackward(MissionObjectId missionObjectId, bool move)
        {
            MissionObjectId = missionObjectId;
            Move = move;
        }

        public CS_VehicleRequestBackward()
        {
        }
