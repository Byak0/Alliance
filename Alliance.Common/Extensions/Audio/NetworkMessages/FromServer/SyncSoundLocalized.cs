...
namespace Alliance.Common.Extensions.Audio.NetworkMessages.FromServer
{
    ...
    public sealed class SyncSoundLocalized : GameNetworkMessage
    {
        ...
        public SyncSoundLocalized(int soundIndex, int soundDuration, Vec3 position)
        {
