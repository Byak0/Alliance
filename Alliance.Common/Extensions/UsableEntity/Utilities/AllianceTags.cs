...
namespace Alliance.Common.Extensions.UsableEntity.Utilities
{
	public static class AllianceTags
	{
		...
		public const string INTERACTIVE_TAG = "al_interactive";
		public const string ITEM_PREFIX_TAG = "al_item_";
		public const string NO_HIDE_ON_USE_TAG = "al_no_hide_on_use";
